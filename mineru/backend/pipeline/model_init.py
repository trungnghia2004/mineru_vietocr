...
def ocr_model_init(det_db_box_thresh=0.3,
    ...
    # Ưu tiên config cho tiếng Việt nếu lang='vi'
    if lang == 'vi':
        det_db_unclip_ratio = 1.8  # Tốt hơn cho text có dấu
    ...
    def get_atom_model(self, atom_model_name: str, **kwargs):
        ...
        if atom_model_name in [AtomicModel.WiredTable, AtomicModel.WirelessTable]:
            ...
            key = (
                ...
                lang,  # Đảm bảo 'vi' được cache riêng
...
class MineruPipelineModel:
    def __init__(self, **kwargs):
        ...
        self.lang = kwargs.get('lang', 'vi')  # Default to 'vi' for Vietnamese
